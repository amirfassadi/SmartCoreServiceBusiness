...
@Module({
  ...
  providers: [
    ...
    { provide: GetBusinessLocationsUseCase, useFactory: (business: BusinessRepositoryPort, location: BusinessLocationRepositoryPort) => new GetBusinessLocationsUseCase(business, location), inject: [BUSINESS_REPOSITORY, BUSINESS_LOCATION_REPOSITORY] },
